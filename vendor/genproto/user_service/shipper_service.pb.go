...
var file_shipper_service_proto_rawDesc = []byte{
	...
	0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xf9, 0x02, 0x0a, 0x0e, 0x53, 0x68, 0x69, 0x70, 0x70,
...
var file_shipper_service_proto_depIdxs = []int32{
	...
	1, // 7: genproto.ShipperService.Create:output_type -> genproto.ShipperId
	4, // 8: genproto.ShipperService.Get:output_type -> genproto.Shipper
	3, // 9: genproto.ShipperService.GetAll:output_type -> genproto.GetAllShippersResponse
	5, // 10: genproto.ShipperService.Update:output_type -> google.protobuf.Empty
	5, // 11: genproto.ShipperService.Delete:output_type -> google.protobuf.Empty
	4, // 12: genproto.ShipperService.GetByName:output_type -> genproto.Shipper
