...
var file_branch_user_service_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x09, 0x73, 0x68, 0x69, 0x70, 0x70, 0x65, 0x72, 0x49, 0x64, 0x32, 0xc2, 0x04,
...
var file_branch_user_service_proto_depIdxs = []int32{
	...
	1, // 9: genproto.BranchUserService.Create:output_type -> genproto.BranchUserId
	6, // 10: genproto.BranchUserService.Get:output_type -> genproto.BranchUser
	4, // 11: genproto.BranchUserService.GetAll:output_type -> genproto.GetAllBranchUsersResponse
	7, // 12: genproto.BranchUserService.Update:output_type -> google.protobuf.Empty
	7, // 13: genproto.BranchUserService.Delete:output_type -> google.protobuf.Empty
	6, // 14: genproto.BranchUserService.GetByPhone:output_type -> genproto.BranchUser
	7, // 15: genproto.BranchUserService.UpdateFcmToken:output_type -> google.protobuf.Empty
	7, // 16: genproto.BranchUserService.DeleteFcmToken:output_type -> google.protobuf.Empty
